...
{
    [Node(MenuName = "SetUnitFlag", Type = NodeType.ACTION_SET_UNIT_FLAG, AllowedTypes = new NodeType[] { NodeType.EVENT, NodeType.TARGET })]
    class SetUnitFlag : ActionNode
    {
        public SetUnitFlag()
        {
